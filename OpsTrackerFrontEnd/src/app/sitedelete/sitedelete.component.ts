...
@Component({
  ...
  templateUrl: './sitedelete.component.html',
  styleUrls: ['./sitedelete.component.css']
})
export class SitedeleteComponent implements OnInit {
  ...
  deleteSite(){
    ...
    this.http.delete('http://ec2-13-233-19-198.ap-south-1.compute.amazonaws.com:8080/uds/site/delete/'+this.data)
